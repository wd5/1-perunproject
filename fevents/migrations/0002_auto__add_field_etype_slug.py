...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Etype.slug'
        db.add_column('fevents_etype', 'slug', self.gf('django.db.models.fields.SlugField')(default='slug', max_length=70, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Etype.slug'
        db.delete_column('fevents_etype', 'slug')
