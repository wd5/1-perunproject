...
from fshop.models import Product, Customer, Order, OrderDetail, Category, PaymentMethod, ShippingMethod, Discount, Picture, Review, CallQuery, MarketingGroup

from fshop.forms import ProductAdminForm, PictureAdminForm
