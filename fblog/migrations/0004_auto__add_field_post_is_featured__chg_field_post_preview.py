...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.is_featured'
        db.add_column('fblog_post', 'is_featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Post.preview'
        db.alter_column('fblog_post', 'preview', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Post.is_featured'
        db.delete_column('fblog_post', 'is_featured')

        # Changing field 'Post.preview'
        db.alter_column('fblog_post', 'preview', self.gf('django.db.models.fields.TextField')(default=''))
