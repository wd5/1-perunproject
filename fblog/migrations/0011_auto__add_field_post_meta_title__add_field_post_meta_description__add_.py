...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.meta_title'
        db.add_column('fblog_post', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Post.meta_description'
        db.add_column('fblog_post', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Post.meta_keywords'
        db.add_column('fblog_post', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.meta_title'
        db.delete_column('fblog_post', 'meta_title')
