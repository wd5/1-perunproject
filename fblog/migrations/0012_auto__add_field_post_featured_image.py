...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.featured_image'
        db.add_column('fblog_post', 'featured_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fgallery.Photo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.featured_image'
        db.delete_column('fblog_post', 'featured_image_id')
    ...
    models = {
        ...
        'fblog.post': {
            ...
            'featured_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fgallery.Photo']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
