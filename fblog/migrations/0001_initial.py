...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fblog_post', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fblog.Ptype'], null=True, blank=True)),
        ...
        db.send_create_signal('fblog', ['Post'])


    def backwards(self, orm):
        
        # Deleting model 'Ptype'
        db.delete_table('fblog_ptype')

        # Deleting model 'Post'
        db.delete_table('fblog_post')
