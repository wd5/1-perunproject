...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ptype.slug'
        db.add_column('fblog_ptype', 'slug', self.gf('django.db.models.fields.SlugField')(default='slug', max_length=70, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ptype.slug'
        db.delete_column('fblog_ptype', 'slug')
