...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ptype.title_plural'
        db.add_column('fblog_ptype', 'title_plural', self.gf('django.db.models.fields.CharField')(default='blank', max_length=70), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ptype.title_plural'
        db.delete_column('fblog_ptype', 'title_plural')
