...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.event'
        db.delete_column('fblog_post', 'event_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Post.event'
        db.add_column('fblog_post', 'event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fevents.Event'], null=True, blank=True), keep_default=False)
